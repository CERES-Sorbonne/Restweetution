...
async def launch():
    ...
    await searcher.collect(rule=main_conf.searcher_rule, count_tweets=False, fields=main_conf.query_fields, recent=False, start_time=datetime(2017, 11, 10, 16, 44, 20, 323095), end_time=datetime(2022, 2, 1), max_results=100)
